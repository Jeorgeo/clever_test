...
class YAManager
{
    ...
    private static function sendRequest($params)
    {
        ...
        $getParams = getParamsForRequest($params);
...
//            echo '</pre>';
     ...
     * @return mixed
     */
    private static function getParamsForRequest($params)
    {
        $token = self::TOKEN;
        ...
        switch ($params['type_data'])
        {
            ...
            case 'json':
                ...
                $result['body'] = json_encode($params, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
                break;
        }
